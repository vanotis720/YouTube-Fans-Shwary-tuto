...
@section('content')
    ...
    <main class="mx-auto max-w-6xl px-6 pb-24">
        <section class="grid gap-6 lg:grid-cols-3">
            <article
                class="group rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:-translate-y-1 hover:border-amber-200/80">
                <p class="text-xs uppercase tracking-[0.3em] text-amber-100">Découverte</p>
                <h2 class="title-font mt-3 text-3xl text-white">Kit Étincelle</h2>
                <p class="mt-2 text-sm text-slate-200">Aidez aux mises à jour du matériel et aux sessions de
                    planification.</p>
                <p class="mt-8 text-3xl font-semibold text-amber-300">$10 - 22.000 CDF</p>
            ...
            <article
                class="group rounded-3xl border border-amber-200/60 bg-gradient-to-b from-amber-100/80 to-rose-100/80 p-8 text-slate-900 shadow-xl shadow-amber-300/30 transition hover:-translate-y-1">
                <p class="text-xs uppercase tracking-[0.3em] text-slate-600">Coup de coeur</p>
                <h2 class="title-font mt-3 text-3xl">Montée en Puissance</h2>
                <p class="mt-2 text-sm text-slate-700">Aidez-moi à tourner un démo ambitieux avec meilleure lumière et
                    accessoires.
                </p>
                <p class="mt-8 text-3xl font-semibold">$50 - 110.000 CDF</p>
                <ul class="mt-6 space-y-2 text-sm text-slate-800">
                    <li>✦ Nom au générique</li>
            ...
            <article
                class="group rounded-3xl border border-white/10 bg-white/5 p-8 transition hover:-translate-y-1 hover:border-rose-200/70">
                <p class="text-xs uppercase tracking-[0.3em] text-rose-100">Visionnaire</p>
                <h2 class="title-font mt-3 text-3xl text-white">Mécène du Studio</h2>
                <p class="mt-2 text-sm text-slate-200">Financez un tutoriel complet et des ressources interactives pour
                    la communauté.</p>
                <p class="mt-8 text-3xl font-semibold text-rose-200">$100 - 220.000 CDF</p>
                <ul class="mt-6 space-y-2 text-sm text-slate-200">
                    <li>✦ Vidéo de remerciement personnelle</li>
